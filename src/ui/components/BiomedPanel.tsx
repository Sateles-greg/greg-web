...
const BiomedPanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      setMedicalHistory(await biomedDataService.getUnifiedMedicalHistory());
      setBiosensor(await biomedDataService.getRealtimeBiosensorData());
      setGenomic(await biomedDataService.getGenomicData());
      setEnvironment(await biomedDataService.getEnvironmentalData());
      setDiagnosis(await diagnosticService.generateDifferentialDiagnosis());
      setTreatment(await treatmentService.suggestTreatmentPlan());
      setPrivacy(await ethicsService.getPrivacyStatus());
      setLiterature(await biomedKnowledgeService.getLatestLiterature());

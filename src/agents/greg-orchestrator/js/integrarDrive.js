...
exports.uploadRelatorioDrive = uploadRelatorioDrive;
var googleapis_1 = require("googleapis");
var dotenv = require("dotenv");
dotenv.config();
function uploadRelatorioDrive(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var fs, auth, drive, res, e_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!process.env.GOOGLE_KEY_FILE) {
                        ...
                        return [2 /*return*/, { fallback: true, error: 'GOOGLE_KEY_FILE não definido' }];
                    }
                ...
                case 3:
                    e_1 = _a.sent();
                    console.error('Erro ao enviar para o Drive:', e_1);
                    fs.copyFileSync(filePath, 'public/logs/relatorio-simbiotico.txt');
                    return [2 /*return*/, { fallback: true, error: e_1 }];
